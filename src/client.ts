...
import { CoinbaseIntxCredentials } from './credentials';
import { toCamelCase } from './shared/toCamelCase';

export class CoinbaseIntxClient extends CoinbaseClient {
  constructor(credentials?: CoinbaseIntxCredentials, apiBasePath?: string) {
